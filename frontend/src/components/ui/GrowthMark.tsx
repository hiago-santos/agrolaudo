/**
 * Marca da AgroLaudo — recorte de folha/broto crescendo em espiral.
 *
 * Path original é o glifo da marca do Overleaf (github.com/glincker/thesvg,
 * public/icons/overleaf/default.svg — cor de origem #47A141), reaproveitado por
 * decisão explícita do time: `currentColor` aqui pra herdar `text-accent`/tema em vez
 * da cor de marca do Overleaf.
 */
